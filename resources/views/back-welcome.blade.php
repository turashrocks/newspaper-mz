...
<html lang="en">
  ...
  <body>
    ...
    <!-- Header -->
    <header class="header text-center text-white" style="background: #e50613">
      <div class="container">
                ...
                @foreach($posts as $post)
                  <div class="col-md-6">
                    <div class="card border hover-shadow-6 mb-6 d-block">
                      <a href="#"><img class="card-img-top" src="<?php echo asset("storage/$post->image")?>" alt="Card image cap"></a>
